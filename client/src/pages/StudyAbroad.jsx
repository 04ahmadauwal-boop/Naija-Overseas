  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="relative z-20 flex-1 flex items-center">
          <div className="max-w-7xl mx-auto px-6 py-24 w-full grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.06] mb-5 drop-shadow-lg">
                Study in<br />
      ...
      <section id="destinations" className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Choose Your Dream Destination</h2>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Services We Offer</h2>
      ...
      <section className="py-20 px-4 bg-gray-950 text-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">Benefits of Studying Abroad</h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-5">Why Choose Naija &amp; Overseas?</h2>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Our Success Stories</h2>
      ...
      <section className="py-20 px-4 bg-green-900 text-white">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-extrabold mb-4">Ready to start your international journey?</h2>
